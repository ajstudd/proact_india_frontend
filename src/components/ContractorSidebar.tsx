...
import { FiMenu, FiChevronLeft, FiHome, FiClipboard, FiUpload, FiBell, FiSettings } from "react-icons/fi";
import { motion } from "framer-motion";

const menuItems = [
    { label: "Dashboard", icon: FiHome, path: "/contractor-dashboard" },
    ...
    { label: "Notifications", icon: FiBell, path: "/contractor-notifications" },
    { label: "Settings", icon: FiSettings, path: "/contractor-settings" }
];

const ContractorSidebar = ({ isOpen, toggleSidebar }: { isOpen: boolean; toggleSidebar: () => void }) => {
    ...
    return (
        ...
        >
            <Flex align="center" className="p-4 border-b border-gray-700">
                ...
                {isOpen && <Text ml={4} fontSize="lg" fontWeight="bold">Contractor</Text>}
            </Flex>
