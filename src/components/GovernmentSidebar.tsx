...
import { FiMenu, FiChevronLeft, FiHome, FiClipboard, FiUsers, FiBell, FiBriefcase, FiSettings } from "react-icons/fi";
    ...
    return (
        ...
        >
            <Flex align="center" className="p-4 border-b border-gray-700">
                ...
                {isOpen && <Text ml={4} fontSize="lg" fontWeight="bold">Government</Text>}
            </Flex>
